...
Kpp = 0.00115; % (pre-production unit: 0.0015)
Kyy = 0.0034; % (pre-production unit: 0.0040)
...
Dp = 0.0078; % pitch axis (pre-production unit: Dp = 0.0226) 
Dy = 0.0130; % yaw axis (pre-production unit: Dy = 0.0211)
